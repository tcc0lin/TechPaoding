...
import com.lateautumn4lin.cattle.sqliteCattle.MySQLCipherOpenHelper;
 ...
 */
public class SQLcipherCattleActivity extends AppCompatActivity {
    private SQLiteDatabase database;
    /**
     * The constant DATABASE_NAME.
     */
    @SuppressLint("SdCardPath")
    public static final String DATABASE_NAME = "/data/data/com.lateautumn4lin.cattle/databases/test_cipher.db";
...
//        判断是否具备存储权限以及重建db
    ...
    public void  clickBack(View view){
        Intent intent = new Intent(SQLcipherCattleActivity.this, MainActivity.class);
...
//            方法一
            ...
            database = SQLiteDatabase.openOrCreateDatabase(dbFile, "paoding", null);
//            方法二
            MySQLCipherOpenHelper sqLiteOpenHelper = new MySQLCipherOpenHelper(this, DATABASE_NAME);
            database = sqLiteOpenHelper.getWritableDatabase("paoding");
//            获取database实例之后创建表
